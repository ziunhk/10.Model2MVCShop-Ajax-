	...
	<script type="text/javascript">
		...
		//==>"가입"  Event 연결
		 $(function() {
			...
			//==> 아이디 중복검사 : ajax를 쓰면 checkDuplication.jsp가 필요없다
			$("#userId").on("keyup", function(event){
				
				var checkId = $("input[name='userId']").val();
				//alert(checkId);
				$("#result_td").html("<p>사용가능</p>");
				...
				$.ajax(
						{
							...
							success : function(JSONData, status){ //JSONData가 실패...의 경우?는 어떻게 로직을?
								...
								//var existedId = ""+JSONData.userId; //in order to set the String
								if(JSONData.userId == checkId){
									alert("checkId : \n'"+checkId+"'는 사용 불가합니다.");
									$("#result_td").html("<p>사용불가</p>");									
								}
	...
	<tr>
		...
		<td class="ct_write01">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="105">
						<input type="text" name="userId" id="userId" class="ct_input_bg" style="width:100px; height:19px"  maxLength="20" >
					</td>
					<td>
